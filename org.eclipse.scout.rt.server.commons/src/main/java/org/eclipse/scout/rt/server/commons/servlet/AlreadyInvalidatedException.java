...
public class AlreadyInvalidatedException extends PlatformException {
  ...
  public AlreadyInvalidatedException(Method method, Object origin) {
    super("Access to '{}' is not allowed because {} is no longer valid (request has been completed).", method, (origin instanceof HttpServletRequest ? "HTTP servlet request" : "HTTP servlet response"));
  }
}

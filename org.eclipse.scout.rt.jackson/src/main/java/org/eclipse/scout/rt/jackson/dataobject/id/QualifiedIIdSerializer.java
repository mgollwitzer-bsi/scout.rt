 ...
 */
public class QualifiedIIdSerializer extends AbstractScoutDataObjectModuleContextStdSerializer<IId> {
  ...
  public void serialize(IId value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
    gen.writeString(m_idCodec.get().toQualified(value, idCodecFlags()));
  }
}

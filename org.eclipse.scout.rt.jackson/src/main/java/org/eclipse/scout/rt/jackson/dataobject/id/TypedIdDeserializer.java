 ...
 */
public class TypedIdDeserializer extends AbstractScoutDataObjectModuleContextStdDeserializer<TypedId<IId>> {
  ...
  public TypedId<IId> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    try {
      return TypedId.of(m_idCodec.get().fromQualified(rawValue, idCodecFlags()));
    }

 ...
 */
public class UnqualifiedIIdMapKeySerializer extends AbstractScoutDataObjectModuleContextJsonSerializer<IId> {
  ...
  public void serialize(IId value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
    gen.writeFieldName(m_idCodec.get().toUnqualified(value, idCodecFlags()));
  }
}

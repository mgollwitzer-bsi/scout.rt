...
/**
 * Abstract {@link StdDeserializer} with {@link ScoutDataObjectModuleContext} that provides information about the
 * {@link IIdCodecFlag}s of the context.
 */
public abstract class AbstractScoutDataObjectModuleContextStdDeserializer<T> extends StdDeserializer<T> {
  ...
  public AbstractScoutDataObjectModuleContextStdDeserializer(ScoutDataObjectModuleContext moduleContext, Class<?> valueClass) {
    super(valueClass);
    m_moduleContext = moduleContext;
  }

  public AbstractScoutDataObjectModuleContextStdDeserializer(ScoutDataObjectModuleContext moduleContext, JavaType valueType) {
    super(valueType);
    m_moduleContext = moduleContext;
  }

 ...
 */
public class TypedIdSerializer extends AbstractScoutDataObjectModuleContextStdSerializer<TypedId<? extends IId>> {
  ...
  public void serialize(TypedId<? extends IId> value, JsonGenerator gen, SerializerProvider provider) throws IOException {
    gen.writeString(m_idCodec.get().toQualified(value.getId(), idCodecFlags()));
  }
}

 ...
 */
public class QualifiedIIdDeserializer extends AbstractScoutDataObjectModuleContextStdDeserializer<IId> {
  ...
  public IId deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    try {
      return assertInstance(m_idCodec.get().fromQualified(rawValue, idCodecFlags()), m_idClass);
    }

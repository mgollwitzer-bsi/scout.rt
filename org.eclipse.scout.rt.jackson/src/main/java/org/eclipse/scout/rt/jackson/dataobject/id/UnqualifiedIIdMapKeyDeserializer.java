 ...
 */
public class UnqualifiedIIdMapKeyDeserializer extends AbstractScoutDataObjectModuleContextKeyDeserializer {
  ...
  public Object deserializeKey(String key, DeserializationContext ctxt) throws IOException {
    try {
      return m_idCodec.get().fromUnqualified(m_idClass, key, idCodecFlags());
    }

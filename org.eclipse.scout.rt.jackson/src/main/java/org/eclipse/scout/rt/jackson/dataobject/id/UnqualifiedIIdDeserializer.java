 ...
 */
public class UnqualifiedIIdDeserializer extends AbstractScoutDataObjectModuleContextStdDeserializer<IId> {
  ...
  public IId deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    try {
      return m_idCodec.get().fromUnqualified(m_idClass, rawValue, idCodecFlags());
    }
